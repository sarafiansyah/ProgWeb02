    ...
    <div class="nav-item dropdown search-dropdown active">
      ...
      <div class="dropdown-menu">
        <div>
          ...
          <a class="btn btn-primary rounded-pill basicbtn" href="logform.php" style="padding-left: 20px; padding-right: 20px;" role="button">Sign Up</a>
          <a class="wavebtn "href="logform.php"><span>SIGN UP</span> <div class="wave"></div>
</a>
</div>
</nav>